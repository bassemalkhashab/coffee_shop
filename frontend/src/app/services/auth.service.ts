...
export class AuthService {
  ...
  logout() {
    ...
    this.payload = null;
    this.set_jwt();
    window.location.href = "https://coffeeshopprojectudacity.us.auth0.com/v2/logout?client_id=MkxM5Va8rVqLJdNp2tWDr4378AdzdNDm&returnTo=http://localhost:5000/logout-results";
  }
